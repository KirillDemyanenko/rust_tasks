/*
    Напишите программу, которая считывает два целых числа x (i8) и n (u8), устанавливает n-й бит
...
fn main() {
    ...
    let n: u8 = input::<u8>();
    println!("x до установки {n}-го бита");
    println!("в двоичной записи: {:08b}", x);
    println!("в десятичной записи: {x}\n");
    x = x | (1 << n);
    println!("x после установки {n}-го бита");
    println!("в двоичной записи: {:08b}", x);
    println!("в десятичной записи: {x}");
}